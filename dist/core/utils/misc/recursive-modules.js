...
function modules(route) {
    return __awaiter(this, void 0, void 0, function* () {
        const files = [];
        const directories = fs_1.default.readdirSync(route);
        for (let filename of directories) {
            const file = path_1.default.join(route, filename);
            ...
            const result = yield modules(file);
            result.forEach((i) => files.push(i));
        }
        return files;
    });
}
